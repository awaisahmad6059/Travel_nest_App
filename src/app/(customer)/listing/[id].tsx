...
function BookingSheet({
  ...
  return (
    <Sheet visible={visible} title="Book this experience" onClose={onClose}>
      <Text className="text-sm font-semibold text-ink-900 mb-2">Select date</Text>
            ...
            return (
              <Pressable
                ...
                className={cn(
                  ...
                  date === d ? "border-brand-500 bg-brand-50" : "border-ink-200 bg-white",
                )}
              >
                <Text className={cn("text-xl font-bold", date === d ? "text-brand-700" : "text-ink-900")}>
                  {day}
                </Text>
                <Text className={cn("text-xs", date === d ? "text-brand-600" : "text-ink-400")}>
                  {month}
                </Text>
              </Pressable>
            );
